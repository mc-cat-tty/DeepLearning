...
\begin{align*}
&X \in \mathcal{R}^{d_{\text{tokens}} \times d_{\text{model}}} \qquad W_Q, W_K, W_V \in \mathcal{R}^{d_{\text{model}} \times d_{k}} \\ \\
&\mathbf{Q = X \cdot W_Q \qquad K = X \cdot W_K \qquad V = X \cdot W_V} \\ \\
&\rightarrow \quad Q, K, V \in \mathcal{R}^{d_{\text{model}} \times d_{k}}
\end{align*}
