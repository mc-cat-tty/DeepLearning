...
the right of the adjacency matrix, to get the symmatric normalization of $\hat{A}$.
...
\begin{enumerate}
  ...
  $$e_{ij} = \text{LeakyReLU}(a^\top \left[ h_i \| h_j \right])$$
  ...
  $\mathcal{N} \cup \{i\}$, according to the adjacency matrix.
