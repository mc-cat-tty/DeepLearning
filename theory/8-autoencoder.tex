...
that lives in the bigger and more general $\mathbb{R}^N$ space.
...
The regularization term encourages the gradient of the encoder output with respect to the input $x$ to be small.
